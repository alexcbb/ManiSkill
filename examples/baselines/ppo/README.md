...
python ppo_rgb.py --env_id="AnymalC-Reach-v1"   --num_envs=128 --update_epochs=8 --num_minibatches=8   --total_timesteps=500_000_000 --num-steps=40 --num-eval-steps=200   --gamma=0.99 --gae-lambda=0.95 --target-kl=0.05
```
